# -*- encoding: utf-8 -*-
# stub: async-http-faraday 0.12.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Samuel Williams".freeze, "Igor Sidorov".freeze, "Andreas Garnaes".freeze, "Olle Jonsson".freeze, "Benoit Daloze".freeze, "Denis Talakevich".freeze, "Flavio Fernandes".freeze, "Genki Takiuchi".freeze]
